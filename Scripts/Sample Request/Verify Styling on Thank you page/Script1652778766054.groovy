...
WebUI.navigateToUrl('https://enfamil-us.cdn.test.us-east-1.starterkit.rbcloud.io/toddler-sample-request/thank-you/?existing=0')
...
Thank_Banner_Msg_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify Hero Banner - Thankyou Message - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(Thank_Banner_Msg_FontColor, 'rgba(0, 37, 122, 1)', false)

Thank_Banner_Msg_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify Hero Banner - Thankyou Message - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(Thank_Banner_Msg_FontSize, '56px', false)

Thank_Banner_Msg_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify Hero Banner - Thankyou Message - Sample Request'), 
    Font_Weight)
...
Thank_Banner_Msg_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify Hero Banner - Thankyou Message - Sample Request'), 
    Font_Family)
...
Thank_Prod_Bann_Head_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify Product Banner section - Heading -Sample Request'), 
    Font_Color)

WebUI.verifyMatch(Thank_Prod_Bann_Head_FontColor, 'rgba(0, 37, 122, 1)', false)

Thank_Prod_Bann_Head_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify Product Banner section - Heading -Sample Request'), 
    Font_Size)

WebUI.verifyMatch(Thank_Prod_Bann_Head_FontSize, '32px', false)

Thank_Prod_Bann_Head_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify Product Banner section - Heading -Sample Request'), 
    Font_Weight)
...
Thank_Prod_Bann_Head_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify Product Banner section - Heading -Sample Request'), 
    Font_Family)
...
Thank_Guarantee_Section_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify Guarantee Section - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(Thank_Guarantee_Section_FontColor, 'rgba(0, 37, 122, 1)', false)

Thank_Guarantee_Section_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify Guarantee Section - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(Thank_Guarantee_Section_FontSize, '24px', false)

Thank_Guarantee_Section_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify Guarantee Section - Sample Request'), 
    Font_Weight)
...
Thank_Guarantee_Section_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify Guarantee Section - Sample Request'), 
    Font_Family)
