...
WebUI.verifyElementText(findTestObject('Sample Request/Verify alert - Street field - Sample Request'), Street_Address_Empty_Alert)
...
WebUI.verifyElementText(findTestObject('Sample Request/Verify alert - State field - Sample Request'), State_Not_Selected_Alert)

WebUI.verifyElementText(findTestObject('Sample Request/Verify alert - Zip Code - Sample Request'), Zip_Code_Empty_Alert)

WebUI.scrollToElement(findTestObject('Sample Request/Verify label for DoB field - Sample Request'), 0)

WebUI.verifyElementText(findTestObject('Sample Request/Verify alert - DoB field - Sample Request'), DOB_Empty_Alert)
...
FloatFirstLabel_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float First Name Label - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(FloatFirstLabel_FontColor, 'rgba(214, 40, 57, 1)', false)

FloatFirstLabel_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float First Name Label - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(FloatFirstLabel_FontSize, '11px', false)

FloatFirstLabel_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float First Name Label - Sample Request'), 
    Font_Weight)
...
FloatFirstLabel_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float First Name Label - Sample Request'), 
    Font_Family)

WebUI.verifyMatch(FloatFirstLabel_FontFamily, '"Open Sans"', false)

WebUI.sendKeys(findTestObject('Sample Request/Verify Last Name placeholder text - Sample Request'), InVal_Last_Name)
...
FloatLastLabel_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Last Name Label - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(FloatLastLabel_FontColor, 'rgba(214, 40, 57, 1)', false)

FloatLastLabel_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Last Name Label - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(FloatLastLabel_FontSize, '11px', false)

FloatLastLabel_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Last Name Label - Sample Request'), 
    Font_Weight)
...
FloatLastLabel_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Last Name Label - Sample Request'), 
    Font_Family)
...
WebUI.verifyElementText(findTestObject('Sample Request/Verify invalid alert - Email field - Sample Request'), Email_Invalid_Alert)

InvalEmailAlert_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Email field - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(InvalEmailAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

InvalEmailAlert_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Email field - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(InvalEmailAlert_FontSize, '12px', false)

InvalEmailAlert_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Email field - Sample Request'), 
    Font_Weight)
...
InvalEmailAlert_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Email field - Sample Request'), 
    Font_Family)
...
FloatEmailLabel_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Email Label - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(FloatEmailLabel_FontColor, 'rgba(214, 40, 57, 1)', false)

FloatEmailLabel_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Email Label - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(FloatEmailLabel_FontSize, '11px', false)

FloatEmailLabel_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Email Label - Sample Request'), 
    Font_Weight)
...
FloatEmailLabel_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Email Label - Sample Request'), 
    Font_Family)
...
WebUI.verifyElementText(findTestObject('Sample Request/Verify invalid alert - Street field - Sample Request'), Street_Address_Invalid_Alert)

InvalStreetAlert_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Street field - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(InvalStreetAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

InvalStreetAlert_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Street field - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(InvalStreetAlert_FontSize, '12px', false)

InvalStreetAlert_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Street field - Sample Request'), 
    Font_Weight)
...
InvalStreetAlert_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Street field - Sample Request'), 
    Font_Family)
...
FloatStreetLabel_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Street Label - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(FloatStreetLabel_FontColor, 'rgba(214, 40, 57, 1)', false)

FloatStreetLabel_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Street Label - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(FloatStreetLabel_FontSize, '11px', false)

FloatStreetLabel_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Street Label - Sample Request'), 
    Font_Weight)
...
FloatStreetLabel_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Street Label - Sample Request'), 
    Font_Family)
...
WebUI.verifyElementText(findTestObject('Sample Request/Verify invalid alert - Unit field - Sample Request'), Unit_Suite_Invalid_Alert)

InvalUnitAlert_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Unit field - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(InvalUnitAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

InvalUnitAlert_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Unit field - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(InvalUnitAlert_FontSize, '12px', false)

InvalUnitAlert_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Unit field - Sample Request'), 
    Font_Weight)
...
InvalUnitAlert_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Unit field - Sample Request'), 
    Font_Family)
...
FloatUnitLabel_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Unit Label - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(FloatUnitLabel_FontColor, 'rgba(214, 40, 57, 1)', false)

FloatUnitLabel_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Unit Label - Sample Request'), Font_Size)

WebUI.verifyMatch(FloatUnitLabel_FontSize, '11px', false)

FloatUnitLabel_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Unit Label - Sample Request'), 
    Font_Weight)
...
FloatUnitLabel_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify Float Unit Label - Sample Request'), 
    Font_Family)
...
State_Option_Selected = WebUI.getText(findTestObject('Sample Request/Verify option selected in State field - Sample Request'))
...
WebUI.focus(findTestObject('Sample Request/Verify DoB placeholder text - Sample Request'))

WebUI.verifyElementText(findTestObject('Sample Request/Verify invalid alert - Zip code field - Sample Request'), Zip_Code_Invalid_Alert)

InvalZipAlert_FontColor = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Zip code field - Sample Request'), 
    Font_Color)

WebUI.verifyMatch(InvalZipAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

InvalZipAlert_FontSize = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Zip code field - Sample Request'), 
    Font_Size)

WebUI.verifyMatch(InvalZipAlert_FontSize, '12px', false)

InvalZipAlert_FontWeight = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Zip code field - Sample Request'), 
    Font_Weight)
...
InvalZipAlert_FontFamily = WebUI.getCSSValue(findTestObject('Sample Request/Verify invalid alert - Zip code field - Sample Request'), 
    Font_Family)
