...
WebUI.scrollToElement(findTestObject('Sample Request/Verify Date Picker - Sample Request'), 0)

WebUI.delay(2)

WebUI.click(findTestObject('Sample Request/Verify Date Picker - Sample Request'))
...
if (WebUI.verifyElementPresent(findTestObject('Nutramigen/Calendar/Verify Next Month button'), 0) && WebUI.verifyElementPresent(
    ...
    if (WebUI.verifyElementPresent(findTestObject('Nutramigen/Calendar/Verify First Inactive Date in a Month'), 0)) {
    ...
    WebUI.scrollToElement(findTestObject('Sample Request/Verify Date Picker - Sample Request'), 0, FailureHandling.OPTIONAL)

    WebUI.click(findTestObject('Sample Request/Verify Date Picker - Sample Request'), FailureHandling.OPTIONAL)
    ...
    while (WebUI.verifyElementPresent(findTestObject('Nutramigen/Calendar/Verify Previous Month button'), 0)) {
        ...
        Month_Year_Previous = WebUI.getAttribute(findTestObject('Nutramigen/Calendar/Verify Month and Year'), 'aria-label', 
            FailureHandling.OPTIONAL)
    ...
    First_Active_Date = WebUI.getAttribute(findTestObject('Nutramigen/Calendar/Verify First Active Date in a Month'), 'aria-label', 
        FailureHandling.OPTIONAL)
...
} else if (WebUI.verifyElementNotPresent(findTestObject('Nutramigen/Calendar/Verify Next Month button'), 0) && WebUI.verifyElementPresent(
    findTestObject('Nutramigen/Calendar/Verify Previous Month button'), 0)) {
    Month_Year = WebUI.getAttribute(findTestObject('Nutramigen/Calendar/Verify Month and Year'), 'aria-label', FailureHandling.OPTIONAL)
    ...
    println((((('Allowed Date Range ' + (First_Active_Date_Split[1])) + ' ') + (First_Active_Date_Split[2])) + ' ') + (First_Active_Date_Split[
        3]))
} else {
    Page_URL = WebUI.getUrl(FailureHandling.OPTIONAL)
