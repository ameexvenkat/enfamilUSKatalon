...
WebUI.click(findTestObject('Enrollment Series/Step1/Baby Formula Samples Coupons page/Year dropdown'))

WebUI.sendKeys(findTestObject('Enrollment Series/Step1/Baby Formula Samples Coupons page/Year dropdown'), Keys.chord(Keys.UP))

WebUI.sendKeys(findTestObject('Enrollment Series/Step1/Baby Formula Samples Coupons page/Year dropdown'), Keys.chord(Keys.ENTER))
...
WebUI.verifyElementPresent(findTestObject('Enrollment Series/Step1/Baby Formula Samples Coupons page/Error_Upgrade premium'), 
    0)

WebUI.click(findTestObject('Enrollment Series/Step1/Baby Formula Samples Coupons page/Input_Email_Field'))

WebUI.sendKeys(findTestObject('Enrollment Series/Step1/Baby Formula Samples Coupons page/Input_Email_Field'), Keys.chord(
        Keys.HOME, Keys.SHIFT, Keys.DOWN))
...
WebUI.verifyElementPresent(findTestObject('Enrollment Series/Step3/Step3_Toddler_Banner Img'), 0)
...
WebUI.verifyElementPresent(findTestObject('Enrollment Series/Step3/Step3_Customize your chilf_Toddler'), 0)

WebUI.verifyElementPresent(findTestObject('Enrollment Series/Step3/Step3_Relationship to child'), 0)

WebUI.verifyElementPresent(findTestObject('Enrollment Series/Step3/Step3_How are you feeding toddler'), 0)
...
WebUI.scrollToElement(findTestObject('Enrollment Series/Step3/Step3_button_Next'), 0)

WebUI.click(findTestObject('Enrollment Series/Step3/Step3_button_Next'))

WebUI.waitForElementVisible(findTestObject('Enrollment Series/Step4/Step4_button_Upgrade Now'), 0)
...
WebUI.verifyElementPresent(findTestObject('Enrollment Series/Step3/Toddler_Cow milk'), 0)
...
WebUI.waitForElementVisible(findTestObject('Enrollment Series/Enfamil Breadcrumb'), 0)

WebUI.waitForElementVisible(findTestObject('Enrollment Series/Step4/Step4_background img'), 0)

WebUI.verifyElementText(findTestObject('Enrollment Series/Step4/Step4_Header text'), 'Upgrade to Premium for $700 in exclusive offers.')
...
WebUI.verifyElementVisible(findTestObject('Enrollment Series/Step4/Step4_Upgrade_products'), FailureHandling.OPTIONAL)
...
WebUI.verifyElementPresent(findTestObject('Enrollment Series/Step4/Step4_Not yet ready'), 0)
