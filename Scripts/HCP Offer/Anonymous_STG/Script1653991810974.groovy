...
WebUI.navigateToUrl(GlobalVariable.HCP_Page)
...
WebUI.verifyElementText(findTestObject('HCP_Form/Anonymous/FormPage_STG/Banner header_UAT'), 'Get your offer worth up to $15 off on Enfamil NeuroPro™')

String currentUrl = WebUI.getUrl()

if (currentUrl == 'https://enfamil-us.cdn.test.us-east-1.starterkit.rbcloud.io/hcp-offer/') {
    WebUI.verifyElementText(findTestObject('HCP_Form/Anonymous/FormPage/Header text'), 'Fill out the form below to redeem offer')
} else {
    WebUI.verifyElementText(findTestObject('HCP_Form/Anonymous/FormPage/Header text'), 'Fill out the form below to redeem offer.')
}
...
if (currentUrl == 'https://enfamil-us.cdn.test.us-east-1.starterkit.rbcloud.io/hcp-offer/') {
    WebUI.verifyElementText(findTestObject('HCP_Form/Anonymous/FormPage/Error_Highlighted errors'), 'Please correct all highlighted errors and try again!')
} else {
    WebUI.verifyElementText(findTestObject('HCP_Form/Anonymous/FormPage/Error_Highlighted errors_Prod'), 'Please correct all highlighted errors and try again')
}
...
if (currentUrl == 'https://enfamil-us.cdn.test.us-east-1.starterkit.rbcloud.io/hcp-offer/') {
    WebUI.waitForElementVisible(findTestObject('HCP_Form/Anonymous/FormPage_STG/Error_ZipCode_required_UAT'), 30)
} else {
    WebUI.waitForElementVisible(findTestObject('HCP_Form/Anonymous/FormPage/Error_ZipCode_required'), 30)
}
...
rmn = ((Math.random() * 100000000000) as int)

WebUI.setText(findTestObject('HCP_Form/Anonymous/FormPage/Phone field_Error_Focus'), ('' + rmn) + '')
...
WebUI.scrollToElement(findTestObject('HCP_Form/Anonymous/FormPage/Code_Activation_valid code'), 0)

WebUI.click(findTestObject('HCP_Form/Anonymous/FormPage/Code_Activation_valid code'))

WebUI.sendKeys(findTestObject('HCP_Form/Anonymous/FormPage/Code_Activation_valid code_focus'), Keys.chord(Keys.SHIFT, Keys.HOME))

WebUI.sendKeys(findTestObject('HCP_Form/Anonymous/FormPage/Code_Activation_valid code_focus'), Keys.chord(Keys.DELETE))

WebUI.setText(findTestObject('HCP_Form/Anonymous/FormPage/Code_Activation_valid code_focus'), 'BYBR4T')
