...
EmtStreetAlert_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - Street field'), 
    Font_Color)

WebUI.verifyMatch(EmtStreetAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

EmtStreetAlert_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - Street field'), 
    Font_Size)

WebUI.verifyMatch(EmtStreetAlert_FontSize, '12px', false)

EmtStreetAlert_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - Street field'), 
    Font_Weight)
...
EmtStreetAlert_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - Street field'), 
    Font_Family)
...
EmtStateAlert_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - State field'), 
    Font_Color)

WebUI.verifyMatch(EmtStateAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

EmtStateAlert_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - State field'), 
    Font_Size)

WebUI.verifyMatch(EmtStateAlert_FontSize, '12px', false)

EmtStateAlert_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - State field'), 
    Font_Weight)
...
EmtStateAlert_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - State field'), 
    Font_Family)

WebUI.verifyMatch(EmtStateAlert_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

EmtZipAlert_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - zip code field'), 
    Font_Color)

WebUI.verifyMatch(EmtZipAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

EmtZipAlert_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - zip code field'), 
    Font_Size)

WebUI.verifyMatch(EmtZipAlert_FontSize, '12px', false)

EmtZipAlert_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - zip code field'), 
    Font_Weight)
...
EmtZipAlert_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - zip code field'), 
    Font_Family)

WebUI.verifyMatch(EmtZipAlert_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

EmtPassAlert_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - Password field'), 
    Font_Color)

WebUI.verifyMatch(EmtPassAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

EmtPassAlert_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - Password field'), 
    Font_Size)

WebUI.verifyMatch(EmtPassAlert_FontSize, '12px', false)

EmtPassAlert_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - Password field'), 
    Font_Weight)
...
EmtPassAlert_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - Password field'), 
    Font_Family)

WebUI.verifyMatch(EmtPassAlert_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

EmtDobAlert_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - DoB field'), 
    Font_Color)

WebUI.verifyMatch(EmtDobAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

EmtDobAlert_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - DoB field'), 
    Font_Size)

WebUI.verifyMatch(EmtDobAlert_FontSize, '12px', false)

EmtDobAlert_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - DoB field'), 
    Font_Weight)
...
EmtDobAlert_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - DoB field'), 
    Font_Family)

WebUI.verifyMatch(EmtDobAlert_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

EmtRelAlert_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - relationship field'), 
    Font_Color)

WebUI.verifyMatch(EmtRelAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

EmtRelAlert_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - relationship field'), 
    Font_Size)

WebUI.verifyMatch(EmtRelAlert_FontSize, '12px', false)

EmtRelAlert_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - relationship field'), 
    Font_Weight)
...
EmtRelAlert_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - relationship field'), 
    Font_Family)

WebUI.verifyMatch(EmtRelAlert_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

EmtWicAlert_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - WIC status field'), 
    Font_Color)

WebUI.verifyMatch(EmtWicAlert_FontColor, 'rgba(206, 17, 38, 1)', false)

EmtWicAlert_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - WIC status field'), 
    Font_Size)

WebUI.verifyMatch(EmtWicAlert_FontSize, '12px', false)

EmtWicAlert_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - WIC status field'), 
    Font_Weight)
...
EmtWicAlert_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Field Validation for invalid data/Page_Nutramigen  Enfamil/Verify alert - WIC status field'), 
    Font_Family)
