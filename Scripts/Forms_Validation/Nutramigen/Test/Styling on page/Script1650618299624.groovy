...
HeroDis_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify disclaimer text in hero banner section below description'), 
    Font_Color)

WebUI.verifyMatch(HeroDis_FontColor, 'rgba(0, 37, 122, 1)', false)

HeroDis_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify disclaimer text in hero banner section below description'), 
    Font_Size)

WebUI.verifyMatch(HeroDis_FontSize, '16px', false)

HeroDis_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify disclaimer text in hero banner section below description'), 
    Font_Family)
...
LasttNameHolder_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Last Name placeholder text for input field'), 
    Font_Color)

WebUI.verifyMatch(LasttNameHolder_FontColor, 'rgba(33, 33, 33, 1)', false)

LasttNameHolder_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Last Name placeholder text for input field'), 
    Font_Size)
...
AddressLabel_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label for address field - Styling'), 
    Font_Color)

WebUI.verifyMatch(AddressLabel_FontColor, 'rgba(0, 37, 122, 1)', false)

AddressLabel_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label for address field - Styling'), 
    Font_Size)

WebUI.verifyMatch(AddressLabel_FontSize, '18px', false)

AddressLabel_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label for address field - Styling'), 
    Font_Weight)
...
AddressLabel_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label for address field - Styling'), 
    Font_Family)

WebUI.verifyMatch(AddressLabel_FontFamily, '"Quatro Slab Semi-Bold", Arial, Helvetica, sans-serif', false)

AddressLabel_1_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label 1 for address field'), 
    Font_Color)

WebUI.verifyMatch(AddressLabel_1_FontColor, 'rgba(0, 0, 0, 1)', false)

AddressLabel_1_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label 1 for address field'), 
    Font_Size)

WebUI.verifyMatch(AddressLabel_1_FontSize, '16px', false)

AddressLabel_1_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label 1 for address field'), 
    Font_Weight)
...
AddressLabel_1_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label 1 for address field'), 
    Font_Family)
...
StateHolder_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify State placeholder text for dropdown field'), 
    Font_Weight)
...
StateHolder_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify State placeholder text for dropdown field'), 
    Font_Family)
...
PassLabel_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label for password field'), 
    Font_Color)

WebUI.verifyMatch(PassLabel_FontColor, 'rgba(0, 37, 122, 1)', false)

PassLabel_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label for password field'), 
    Font_Size)

WebUI.verifyMatch(PassLabel_FontSize, '18px', false)

PassLabel_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label for password field'), 
    Font_Weight)
...
PassLabel_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify label for password field'), 
    Font_Family)

WebUI.verifyMatch(PassLabel_FontFamily, '"Quatro Slab Semi-Bold", Arial, Helvetica, sans-serif', false)

PassHolder_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify password placeholder text for input field'), 
    Font_Color)
...
PassRulesHead_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password rules heading below password input field'), 
    Font_Color)

WebUI.verifyMatch(PassRulesHead_FontColor, 'rgba(90, 91, 94, 1)', false)

PassRulesHead_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password rules heading below password input field'), 
    Font_Size)

WebUI.verifyMatch(PassRulesHead_FontSize, '14px', false)

PassRulesHead_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password rules heading below password input field'), 
    Font_Weight)
...
PassRulesHead_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password rules heading below password input field'), 
    Font_Family)

WebUI.verifyMatch(PassRulesHead_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PassRules1_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 1'), 
    Font_Color)

WebUI.verifyMatch(PassRules1_FontColor, 'rgba(90, 91, 94, 1)', false)

PassRules1_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 1'), 
    Font_Size)

WebUI.verifyMatch(PassRules1_FontSize, '14px', false)

PassRules1_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 1'), 
    Font_Weight)
...
PassRules1_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 1'), 
    Font_Family)

WebUI.verifyMatch(PassRules1_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PassRules2_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 2'), 
    Font_Color)

WebUI.verifyMatch(PassRules2_FontColor, 'rgba(90, 91, 94, 1)', false)

PassRules2_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 2'), 
    Font_Size)

WebUI.verifyMatch(PassRules2_FontSize, '14px', false)

PassRules2_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 2'), 
    Font_Weight)
...
PassRules2_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 2'), 
    Font_Family)

WebUI.verifyMatch(PassRules2_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PassRules3_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 3'), 
    Font_Color)

WebUI.verifyMatch(PassRules3_FontColor, 'rgba(90, 91, 94, 1)', false)

PassRules3_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 3'), 
    Font_Size)

WebUI.verifyMatch(PassRules3_FontSize, '14px', false)

PassRules3_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 3'), 
    Font_Weight)
...
PassRules3_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 3'), 
    Font_Family)

WebUI.verifyMatch(PassRules3_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PassRules4_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 4'), 
    Font_Color)

WebUI.verifyMatch(PassRules4_FontColor, 'rgba(90, 91, 94, 1)', false)

PassRules4_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 4'), 
    Font_Size)

WebUI.verifyMatch(PassRules4_FontSize, '14px', false)

PassRules4_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 4'), 
    Font_Weight)
...
PassRules4_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 4'), 
    Font_Family)

WebUI.verifyMatch(PassRules4_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PassRules5_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 5'), 
    Font_Color)

WebUI.verifyMatch(PassRules5_FontColor, 'rgba(90, 91, 94, 1)', false)

PassRules5_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 5'), 
    Font_Size)

WebUI.verifyMatch(PassRules5_FontSize, '14px', false)

PassRules5_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 5'), 
    Font_Weight)
...
PassRules5_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 5'), 
    Font_Family)

WebUI.verifyMatch(PassRules5_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PassRules6_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 6'), 
    Font_Color)

WebUI.verifyMatch(PassRules6_FontColor, 'rgba(90, 91, 94, 1)', false)

PassRules6_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 6'), 
    Font_Size)

WebUI.verifyMatch(PassRules6_FontSize, '14px', false)

PassRules6_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 6'), 
    Font_Weight)
...
PassRules6_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Password Rules list 6'), 
    Font_Family)

WebUI.verifyMatch(PassRules6_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PhoneLabel_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label'), 
    Font_Color)

WebUI.verifyMatch(PhoneLabel_FontColor, 'rgba(0, 37, 122, 1)', false)

PhoneLabel_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label'), 
    Font_Size)

WebUI.verifyMatch(PhoneLabel_FontSize, '18px', false)

PhoneLabel_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label'), 
    Font_Weight)
...
PhoneLabel_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label'), 
    Font_Family)

WebUI.verifyMatch(PhoneLabel_FontFamily, '"Quatro Slab Semi-Bold", Arial, Helvetica, sans-serif', false)

PhoneLabel1_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label 1'), 
    Font_Color)

WebUI.verifyMatch(PhoneLabel1_FontColor, 'rgba(0, 37, 122, 1)', false)

PhoneLabel1_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label 1'), 
    Font_Size)

WebUI.verifyMatch(PhoneLabel1_FontSize, '18px', false)

PhoneLabel1_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label 1'), 
    Font_Weight)
...
PhoneLabel1_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label 1'), 
    Font_Family)

WebUI.verifyMatch(PhoneLabel1_FontFamily, '"Quatro Slab Semi-Bold", Arial, Helvetica, sans-serif', false)

PhoneLabel2_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label 2'), 
    Font_Color)

WebUI.verifyMatch(PhoneLabel2_FontColor, 'rgba(0, 0, 0, 1)', false)

PhoneLabel2_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label 2'), 
    Font_Size)

WebUI.verifyMatch(PhoneLabel2_FontSize, '16px', false)

PhoneLabel2_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label 2'), 
    Font_Weight)
...
PhoneLabel2_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone field label 2'), 
    Font_Family)

WebUI.verifyMatch(PhoneLabel2_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PhoneHolder_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone placehoder text for input field'), 
    Font_Color)

WebUI.verifyMatch(PhoneHolder_FontColor, 'rgba(33, 33, 33, 1)', false)

PhoneHolder_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone placehoder text for input field'), 
    Font_Size)

WebUI.verifyMatch(PhoneHolder_FontSize, '14px', false)

PhoneHolder_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone placehoder text for input field'), 
    Font_Weight)
...
PhoneHolder_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify Phone placehoder text for input field'), 
    Font_Family)

WebUI.verifyMatch(PhoneHolder_FontFamily, '"Open Sans", Arial, Helvetica, sans-serif', false)

PhoneConsent_FontColor = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify consent Message for phone checkbox field'), 
    Font_Color)

WebUI.verifyMatch(PhoneConsent_FontColor, 'rgba(33, 33, 33, 1)', false)

PhoneConsent_FontSize = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify consent Message for phone checkbox field'), 
    Font_Size)

WebUI.verifyMatch(PhoneConsent_FontSize, '14px', false)

PhoneConsent_FontWeight = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify consent Message for phone checkbox field'), 
    Font_Weight)
...
PhoneConsent_FontFamily = WebUI.getCSSValue(findTestObject('Nutramigen/Element Text verification/Page_Nutramigen  Enfamil/Verify consent Message for phone checkbox field'), 
    Font_Family)
