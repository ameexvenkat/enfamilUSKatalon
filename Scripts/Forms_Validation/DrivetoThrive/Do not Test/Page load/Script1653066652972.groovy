...
WebUI.rightClick(findTestObject('Page_Nutramigen  Enfamil/div_Nutramigen Savings and SupportJoin now _8517f8'))

WebUI.rightClick(findTestObject('Page_Nutramigen  Enfamil/li_Enfamil products unaffected by recall. L_5ada8a'))
