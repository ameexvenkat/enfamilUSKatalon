...
WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_1. Shop and earn rewards'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_2. Engage and earn'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_3. Share the love'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_4. Formula samples'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_5. Discount checks  digital rebates'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_6. Belly Badges'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_7. A Chance to win free formula for a year'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_8. Tips tailored to you'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_9. Access to our mobile app'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_10. Special offers'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/p_Get special gifts and discounts from our _31c1cb'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h2_Join Enfamil Family Beginnings for up to_78b78f'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/p_By clicking Join Now and Enter Sweepstake_0b0cd5'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/div_ALTERNATIVE PROGRAMS'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_Drive to Thrive Support Program'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/h3_Nutramigen Savings and Support Program'), 
    0)
...
WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/p_1. Every motherhood journey is unique, so_de9b3b'), 
    0)

WebUI.scrollToElement(findTestObject('Object Repository/Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/span_Enfamil Family Beginnings'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/a_Learn more_enrollment'), 
    0)

WebUI.verifyElementText(findTestObject('Form Verification/Enrollment Form/Page_Free Baby Formula Samples  Coupons  Enfamil/a_Learn more_enrollment'), 
    'Learn more')
