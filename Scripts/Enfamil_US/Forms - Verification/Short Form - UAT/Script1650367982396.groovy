...
WebUI.verifyElementPresent(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/div_PREMIUM ENFAMIL FAMILY BEGINNINGS'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/div_PREMIUM ENFAMIL FAMILY BEGINNINGS'), 
    'PREMIUM ENFAMIL FAMILY BEGINNINGS')

WebUI.verifyElementPresent(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/h3_Join today for your Premium Welcome Gift_ec768f'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/h3_Join today for your Premium Welcome Gift_ec768f'), 
    'Join today for your Premium Welcome Gift, exclusive offers and so much more!')

WebUI.verifyElementPresent(findTestObject('Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/input_First name_registerGivenNameField_1'), 
    0)

WebUI.verifyElementClickable(findTestObject('Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/input_First name_registerGivenNameField_1'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/input_Last name_registerFamilyNameField_1'), 
    0)

WebUI.verifyElementClickable(findTestObject('Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/input_Last name_registerFamilyNameField_1'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/input_Email_registerEmailField_1'), 
    0)

WebUI.verifyElementClickable(findTestObject('Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/input_Email_registerEmailField_1'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/input_Password_registerPasswordField_1'), 
    0)

WebUI.verifyElementClickable(findTestObject('Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/input_Password_registerPasswordField_1'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/button_Hide'), 
    0)

WebUI.verifyElementClickable(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/button_Hide'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/div_Password must containAt least 8 charact_619724'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/div_Password must containAt least 8 charact_619724'), 
    'Password must contain:\nAt least 8 characters\nA lowercase letter\nAn uppercase letter\nA number\nA special character\nMust not be your email address')

WebUI.verifyElementPresent(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/button_Next'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/Form Verification/Premium short form/Page_Premium Enfamil Family Beginnings/button_Next'), 
    'Next')
