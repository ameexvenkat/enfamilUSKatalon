...
WebUI.verifyElementText(findTestObject('Object Repository/Header/Page_/span_Supplementing'), 'Supplementing with Formula')
...
WebUI.verifyElementText(findTestObject('Object Repository/Header/Page_/span_Feeding Issues'), 'Baby Feeding Issues')
