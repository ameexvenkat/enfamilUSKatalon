...
WebUI.verifyElementText(findTestObject('Object Repository/Header/Page_Enfamil Newborn, Infant  Toddler Nutri_2e0999/a_WhatsApp'), 
    'WhatsApp')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Header/Page_Enfamil Newborn, Infant  Toddler Nutri_2e0999/a_WhatsApp'), 
    0)
...
WebUI.verifyElementClickable(findTestObject('Object Repository/Header/Page_/a_WhatsApp'))

WebUI.click(findTestObject('Object Repository/Header/Page_/a_Email us'))

WebUI.switchToWindowUrl('https://enfamil-us.cdn.test.us-east-1.starterkit.rbcloud.io/contact-us/')
...
WebUI.switchToWindowUrl('https://enfamil-us.cdn.test.us-east-1.starterkit.rbcloud.io/help-center/')
