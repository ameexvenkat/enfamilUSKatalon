...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/p_Enfamil Family Beginnings'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/img'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/button_Why'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/button_Join now'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Terms of Use'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Privacy Policy'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Sweepstakes Official Rules'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/div_Download our app'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/p_For savings and personalized tips'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/img_1'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/img_1_2'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/span_Follow us'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Chat with us'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Email us'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/img_1_2_3'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Browse FAQs'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/img_1_2_3_4'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Call us (1-800-BABY123)'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/img_1_2_3_4_5'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/img_1_2_3_4_5_6_7'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_For Healthcare professionals'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Enfamil Wholesale'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Do Not Sell My Information'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Privacy Policy_1'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Terms of Use_1'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/a_Terms of Sale'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Footer/Footer_Elements/button_Cookie Preference'), 
    0)
